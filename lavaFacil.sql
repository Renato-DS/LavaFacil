...
CREATE TABLE IF NOT EXISTS `lavaFacil`.`carros` (
...
CREATE TABLE IF NOT EXISTS `lavaFacil`.`usuario` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lavaFacil`.`lavagens` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lavaFacil`.`opcoes` (
    `id` INT NOT NULL AUTO_INCREMENT,
